...
UPDATE applications SET status='SUBMITTED_BY_CDO' WHERE id='90000000-0000-0000-0000-000000000101';
UPDATE applications SET status='BM_RECOMMENDED' WHERE id='90000000-0000-0000-0000-000000000102';
UPDATE applications SET status='AM_RECOMMENDED' WHERE id='90000000-0000-0000-0000-000000000103';
